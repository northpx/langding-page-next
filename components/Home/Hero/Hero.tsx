...
const Hero = () => {
  return (
    <div className='relative w-full h-[120vh] sm:h-[100vh]'>
        ...
        {/* {text content} */}
        <div className='absolute top-[50%] left-[50%] translate-[-50%] w-full'>
            <div className='flex justify-center items-center flex-col w-full h-full'>
                <div data-aos='fade-up'>
                    <p className='text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] text-white uppercase font-bold  tracking-[0.7rem]'>Lets enjoy the nature</p>
